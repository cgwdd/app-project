        ...
        <div class="ui centered card" id="card">
          ...
          <el-form :model="loginForm" status-icon :rules="rules" ref="loginForm" label-width="100px" class="demo-loginForm">
            <el-form-item label="用户名" prop="username" class="label1">
              <el-input type="password" v-model="loginForm.username" autocomplete="off" style="width:200px"></el-input>
            </el-form-item>
            ...
            <el-form-item>
              <el-button type="primary" @click="login" style="width:200px;">提交</el-button>
            </el-form-item>
             <div id="together">
    ...
    submitForm (formName) {
      this.$refs[formName].validate( valid => {
        if (valid) {
          ...
          let _this = this
          // 手机用户名和密码发送给后端
          this.axios.post('http://localhost:888/checklogin', {
            params: {
          ...
          .then(response => {
            console.log('接受后端响应登陆请求的数据：', response.data)
          })
        } else {
